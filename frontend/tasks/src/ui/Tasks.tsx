            ...
            <div className="flex space-x-2">
             {task._id && (
                        <div className='flex gap-2'>
                            <Link to={`/dashboard/tasks/${task._id}/edit`}><p className="text-white p-2 bg-blue-400 rounded-md hover:text-blue-300 transition-colors">Modifier</p></Link>
                            <button type='button' className='bg-red-400 text-white p-2 rounded-md hover:text-red-300 transition-colors' onClick={async () => {
                                if (task._id) {
