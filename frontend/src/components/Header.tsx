...
const Header = () => {
  ...
  return (
    <div className="bg-slate-900/50 backdrop-blur-sm  sticky top-0 z-50">
      <header>
        ...
        {/* Drawer mobile */}
        {showMenu && (
          <div className="fixed top-0 right-0 h-full w-4/5 max-w-sm bg-slate-900 text-white backdrop-blur-md border-l border-slate-700/50 z-50 p-6 flex flex-col">
            {/* Header du drawer */}
            ...
            <div className="flex flex-col space-y-4">
              <button
                type="button"
                onClick={() => setShowNotifications(!showNotifications)}
                className="flex items-center space-x-3 text-slate-900 hover:text-white transition-colors"
              >
                <Bell className="w-6 h-6" />
